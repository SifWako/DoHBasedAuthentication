...
PUBLIC_KEY_TTL_HOURS = 0.0045  # Time-to-live for the public key in hours
...
def initiate_authentication():
    ...
    data_payload = {
        ...
        "ttl_hours": ttl_hours}
    time.sleep(2)
    print(Fore.GREEN + "1. SENT CSR AND TTL HOURS TO THE DOH SERVER." + Style.RESET_ALL)
    ...
    try:
        ...
        if not challenge:
            ...
            return
        time.sleep(0)
        print(f"CHALLENGE '{challenge}' IS RECEIVED SUCCESSFULLY!")
        solution = str(eval(challenge))  # Be cautious with eval
        challenge_path = solution
        challenge_solution = solution
        time.sleep(3)
        print(Fore.GREEN + f"4. PLACED THE SOLUTION {challenge_solution} AT PATH: /.well known/publickeyauth/{challenge_path}" + Style.RESET_ALL)
...
# =============================================================================================================================================================
@app.route('/.well known/publickeyauth/<challenge>', methods=['GET'])
...
def verification_result():
    ...
    message = f"DOHSERVER => YOUR WEBSITE IS {'SUCCESSFULLY VERIFIED' if success else 'NOT SUCCESSFULLY VERIFIED'}. \nDOHSERVER => {ttl_expiration_str}"
    ...
    if success:
        try:
            ...
            time.sleep(2)
            print(f"SAVING MY VERIFIED PUBLIC KEY")
...
if __name__ == "__main__":
    app.debug = False
    print(Fore.BLUE + f"WEB SERVER SERVER example.com is LISTENING ON PORT {PORT}\n" + "✧" * 50 + Style.RESET_ALL)
